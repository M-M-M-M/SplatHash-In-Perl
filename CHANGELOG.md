...
- Add a command-line tool that writes a decoded PNG preview and prints the hash.
- Add a Perl-vs-Go benchmark script for upstream SplatHash assets.
- Add the pinned upstream assets and publish per-image benchmark results.
